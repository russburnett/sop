---
title: SBST Standard Operating Procedures
...
(SOP) for the [Social and Behavioral Sciences Team](http://sbst.gov) (also known
as the [Office of Evaluation Sciences in the General Services
Administration](http://www.gsa.gov/portal/category/100270).^[This SOP is
...
A standard operating procedure records decisions that we have made in the
...
4. A specific example from SBST (if applicable) in which we implemented the
   given procedure.
